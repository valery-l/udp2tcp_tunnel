...
// From Boost samples (without modifications)
// link: http://www.boost.org/doc/libs/1_48_0/doc/html/boost_asio/example/icmp/ipv4_header.hpp
...
public:
  ...
  unsigned short unique_number() const { return decode(6, 7); }
  ...
  void unique_number(unsigned short n) { encode(6, 7, n); }
    ...
    Iterator body_begin, Iterator body_end)
{
  unsigned int sum = (header.type() << 8) + header.code()
    + header.identifier() + header.unique_number();
